...
class Net(nn.Module):
    @staticmethod
    def calc_activation_shape(inp_dim, ksize, dilation=(0, 0), stride=(1, 1), padding=(0, 0)):
    ...
    def __init__(self, norm_type : NormType):
        ...
        out_channels=16
        kernel_size=(3, 3)
        conv_output_shape = Net.calc_activation_shape(inp_dim=inp_dim, ksize=kernel_size, padding=(1,1))
